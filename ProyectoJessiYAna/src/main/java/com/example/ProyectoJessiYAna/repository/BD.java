...
public class BD {
    ...
    private static final String SQL_CREATE="DROP TABLE IF EXISTS PACIENTES; " +
            ...
            "DROP TABLE IF EXISTS ODONTOLOGOS; CREATE TABLE ODONTOLOGOS ( ID INT AUTO_INCREMENT PRIMARY KEY,  MATRICULA VARCHAR(20) NOT NULL, NOMBRE VARCHAR(50) NOT NULL, APELLIDO VARCHAR(50) NOT NULL)";
    private static final String SQL_PRUEBA="INSERT INTO PACIENTES (NOMBRE, APELLIDO, CEDULA, FECHA_INGRESO, DOMICILIO_ID, EMAIL) VALUES" +
            ...
            "INSERT INTO ODONTOLOGOS (MATRICULA, NOMBRE, APELLIDO) VALUES( 'ARKSD64','Ana','Camargo'),( 'AHSHS5','Sol','Silva'); ";
