...
public class BD {
    ...
    private static final String SQL_CREATE="DROP TABLE IF EXISTS PACIENTES; " +
            ...
            "APELLIDO VARCHAR(100) NOT NULL, CEDULA VARCHAR(20) NOT NULL, FECHA_INGRESO DATE NOT NULL, DOMICILIO_ID INT NOT NULL); " +
    ...
    private static final String SQL_PRUEBA="INSERT INTO PACIENTES (NOMBRE, APELLIDO, CEDULA, FECHA_INGRESO, DOMICILIO_ID) VALUES" +
            " ('Jorgito','Pereyra','122222','2023-05-08','1'),('Miguel Angel','Buitrago Rico','333333','2023-05-08','2'); " +
    ...
    public static  Connection getConnection() throws Exception{
        ...
        return DriverManager.getConnection("jdbc:h2:~/C3_0723_ClinicaOdontologica","admin","admin");
    }
}
